                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('posts.create') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-select :options="$categories"  id="category" class="block mt-1 w-full" type="category" name="category" :value="old('category')" required autocomplete="category" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="password" class="block mt-1 w-full"
                                          type="password"
                                          name="password"
